  ...
  const navItems = [
    {
      ...
      isActive: pathname === "/partner/dashboard",
    },
    {
      href: "/partner/venue",
      label: "Manage Venue",
      icon: Building,
      isActive: pathname === "/partner/venue",
    },
    {
      href: "/partner/bookings",
      label: "Bookings",
      icon: ClipboardList,
      isActive: pathname === "/partner/bookings",
    },
    {
      href: "/partner/blocked-dates",
      label: "Blocked Dates",
      icon: Calendar,
      isActive: pathname === "/partner/blocked-dates",
    },
  ];
